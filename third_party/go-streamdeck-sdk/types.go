...
// EvKeyPressPayload is the Payload structure from keyDown/keyUp events.
type EvKeyPressPayload struct {
	Settings         *json.RawMessage `json:"settings"`
	Coordinates      EvCoordinates    `json:"coordinates"`
	State            int              `json:"state"`
...
// EvKeyPress is the payload from keyDown/keyUp events.
type EvKeyPress struct {
	Action  string            `json:"action"`
	Event   string            `json:"event"`
	Context string            `json:"context"`
	Device  string            `json:"device"`
	Payload EvKeyPressPayload `json:"payload"`
}
